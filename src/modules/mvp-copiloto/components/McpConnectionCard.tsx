      ...
      <CardContent className="space-y-4 text-sm">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Endereço oficial do conector, no domínio da Julia — cole essa URL no cliente MCP. Ao
            conectar, ele descobre sozinho o OAuth na raiz desse endereço, você faz login na Julia e
            aprova o acesso de leitura (escopos <code>leads:read</code> e <code>julia:read</code>).
            Não é preciso chave nem header manual.
          </p>
