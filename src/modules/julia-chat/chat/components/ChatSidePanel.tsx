...
import { WhatsAppDataProvider, useWhatsAppData, type SelectedQueue } from '@/modules/julia-chat/chat/contexts/WhatsAppDataContext';
import { ChatHeader } from '@/modules/julia-chat/chat/components/ChatHeader';
import { ChatMessages } from '@/modules/julia-chat/chat/components/ChatMessages';
import { ChatInput } from '@/modules/julia-chat/chat/components/ChatInput';
import { useUserQueueAccess } from '@/hooks/useUserQueueAccess';
import { supabase } from '@/integrations/supabase/client';
import { useQuery } from '@tanstack/react-query';
import { setPendingSelection, type PendingTab } from '@/modules/julia-chat/chat/lib/pendingSelection';
