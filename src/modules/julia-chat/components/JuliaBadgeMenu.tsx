          ...
          <TooltipTrigger asChild>
            <DropdownMenuTrigger asChild>
              <span
                ...
                className={cn(
                  'inline-flex h-5 cursor-pointer select-none items-center justify-center gap-1 overflow-hidden rounded-full border px-1.5 text-[10px] font-medium outline-hidden transition-opacity hover:opacity-80 focus-visible:ring-1 focus-visible:ring-ring',
                  width,
                  tone,
                )}
              >
