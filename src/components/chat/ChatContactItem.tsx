      ...
      <div className="flex-1 min-w-0 overflow-hidden space-y-1">
          ...
          <TooltipProvider delayDuration={200}>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center justify-between gap-1.5 min-w-0 w-full pt-1 mt-0.5 bg-emerald-50/40 dark:bg-emerald-950/20 px-1.5 rounded-sm border border-emerald-100/70 dark:border-emerald-900/40">
        ...
        {crmBuilderLink && (crmBuilderLink.boardName || crmBuilderLink.pipelineName) && (
          <TooltipProvider delayDuration={200}>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center justify-between gap-1.5 min-w-0 w-full pt-1 mt-0.5 bg-blue-50/40 dark:bg-blue-950/20 px-1.5 rounded-sm border border-blue-100/70 dark:border-blue-900/40">
                  <div className="flex items-center gap-1.5 min-w-0 overflow-hidden">
