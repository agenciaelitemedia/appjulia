            ...
            <UaZapiProvider>
              ...
              <Routes>
                ...
                <Route element={<MainLayout />}>
                  ...
                  <Route path="/crm-builder" element={<ProtectedRoute module="crm_builder"><CRMBuilderPage /></ProtectedRoute>} />
                  <Route path="/crm-builder/:boardId" element={<ProtectedRoute module="crm_builder"><BoardPage /></ProtectedRoute>} />
                  <Route path="/crm-builder/:boardId/configuracoes" element={<ProtectedRoute module="crm_builder"><BoardSettingsPage /></ProtectedRoute>} />
