        ...
        {status === 'pending' && (
          <>
            <div className="text-sm text-muted-foreground">
              Você será redirecionado para o Mercado Pago. Após o pagamento, voltaremos para confirmar e liberar seu acesso automaticamente.
            </div>
        ...
        {status === 'paid' && (
          <div className="text-center py-6 space-y-2">
            ...
            <div className="text-sm text-muted-foreground flex items-center gap-2 justify-center">
              <Loader2 className="h-4 w-4 animate-spin" /> Liberando seu acesso à telefonia…
            </div>
            {error && (
              <div className="text-xs text-amber-700 bg-amber-50 dark:bg-amber-950/30 p-2 rounded mt-3">
                {error}
              </div>
            )}
          </div>
