...
export function VideoControls({ onLeave }: VideoControlsProps) {
  ...
  const { networkQuality } = useVideoSettings();
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className="rounded-full w-14 h-14 border-2 bg-background/10 border-border/30 text-foreground hover:bg-background/20"
                >
