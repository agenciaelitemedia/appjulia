...
interface ContractInfoContentProps {
  contractInfo: ContractInfo | null | undefined;
  isLoading: boolean;
  contactName?: string;
}
...
export const ContractInfoContent: React.FC<ContractInfoContentProps> = ({ contractInfo, isLoading, contactName }) => {
  ...
  const handleDownloadContract = async () => {
    ...
    try {
      ...
      toast({ title: 'Download concluído', description: 'O contrato foi baixado com sucesso' });
    } catch (error) {
      console.error('Erro ao baixar contrato:', error);
      toast({ title: 'Erro ao baixar', description: error instanceof Error ? error.message : 'Erro desconhecido', variant: 'destructive' });
    } finally {
          ...
          <div className="grid grid-cols-2 gap-4 p-4 bg-muted/30 rounded-lg">
            ...
            <div className="flex items-center justify-between col-span-2">
              ...
              {contractInfo.status_document === 'SIGNED' && contractInfo.zapsing_doctoken && (
                <Button size="sm" onClick={handleDownloadContract} disabled={downloading} className="gap-2">
                ...
                {contractInfo.case_category_name && (
                  <div>
                    ...
                    <Badge variant="secondary" style={{
                      backgroundColor: contractInfo.case_category_color ? `${contractInfo.case_category_color}20` : undefined,
