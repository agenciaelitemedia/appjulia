...
- [n8n Execute Group](mem://features/n8n-execute/index) — Grupo de Edge Functions migradas do n8n (followup-stop, agent-and-followup-reactive); convenções e catálogo- [Audio Transcription Multicanal](mem://technical/chat/audio-transcription-channel-aware) — chat-transcribe-audio para UaZapi e WABA (API Oficial)
