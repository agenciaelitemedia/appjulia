...
- [Herança de escritório](mem://features/equipe/client-inheritance-chain) — client_id do membro resolvido em cadeia via fn_effective_client_id (vw_equipe, login, cadastro)
