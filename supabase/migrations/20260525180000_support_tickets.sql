...
-- Departamentos e categorias (configuráveis pela gestão)
...
-- Configuração global (SLA por prioridade + CSAT)
...
-- Contador de número sequencial dos tickets
...
-- Thread do ticket: mensagens públicas (solicitante↔suporte), notas internas e eventos
...
-- Numeração sequencial por trigger (evita corrida)
