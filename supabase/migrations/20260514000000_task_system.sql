-- ============================================================
-- Sistema de Tarefas Rankeadas
-- ============================================================

-- 1. Templates de tarefas (admin configura)
...
-- 3. Ledger de pontos (auditoria imutável)
...
-- Trigger: ao completar tarefa → insere automaticamente no ledger
...
-- Função RPC: pontuação agregada por usuário num período
